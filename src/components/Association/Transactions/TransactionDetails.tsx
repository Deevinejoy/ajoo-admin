  ...
  return (
    <div className="p-6 bg-[#F5F7FA] min-h-screen">
      ...
      <div className="flex items-center gap-2 mb-4">
        <button
          onClick={() => navigate(-1)}
          className="text-[#373737] flex items-center gap-x-2 text-lg font-medium"
        >
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 flex flex-col gap-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold text-[#373737] ">
              Transaction Summary
            </h2>
          ...
          <div>
            ...
            <Link
              to="/association/loans/1"
              className="text-[#3161FF] underline"
            >
              Loan #1
            </Link>
          </div>
        ...
        <div className="bg-white rounded-lg p-5 flex flex-col gap-4">
          <h2 className="text-xl font-semibold mb-2 text-[#373737]">
            Payment Details
          </h2>
          <div className="flex flex-col gap-4 ">
            <div className="flex gap-2 border border-[#E7E7E7] rounded-lg flex-col p-3">
              ...
              <div className="flex gap-x-4">
                <div className="bg-[#E5EBFF] w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold text-[#3161FF]">
                  J
                </div>
                <div>
