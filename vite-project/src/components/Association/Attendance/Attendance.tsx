      ...
      {tab === 'Meeting Tracker' ? (
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button className="bg-white border border-[#3161FF] text-[#3161FF] px-4 py-2 rounded-lg" onClick={() => navigate('/association/attendance/monthly-summary')}>View monthly summary</button>
            <button className="bg-white border border-[#3161FF] text-[#3161FF] px-4 py-2 rounded-lg" onClick={() => navigate('/association/attendance/trends')}>View attendance trends</button>
            <button className="bg-white border border-[#3161FF] text-[#3161FF] px-4 py-2 rounded-lg" onClick={() => navigate('/association/attendance/member-report')}>Members report</button>
